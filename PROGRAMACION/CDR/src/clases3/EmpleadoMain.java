...
public class EmpleadoMain {
	...
	public static void main(String[] args) {
		...
		int j=0;
		int k=0;
		double sumSalariosAntes = 0;
		double sumSalariosDespues = 0;
		...
		for(int i=0; i<arrEmpleados.length; i++) {
			sumSalariosAntes = sumSalariosAntes + arrEmpleados[i].getSalario();
		}
		...
		for (int i=0; i<arrEmpleadosNoPlus.length; i++) {
			sumSalariosDespues = sumSalariosDespues + arrEmpleadosNoPlus[i].getSalario();
		}
		
		for (int i=0; i<arrEmpleadosPlus.length; i++) {
			sumSalariosDespues = sumSalariosDespues + arrEmpleadosPlus[i].getSalario();
		}
		
		JOptionPane.showMessageDialog(null, "El salario total de la empresa antes de sumar el plus es de " + sumSalariosAntes + "€.");
		JOptionPane.showMessageDialog(null, "El salario total de la empresa después de sumar el plus es de " + sumSalariosDespues+ "€.");
